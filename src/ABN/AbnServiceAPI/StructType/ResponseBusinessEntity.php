...
class ResponseBusinessEntity extends ResponseBody
{
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \ABN\AbnServiceAPI\StructType\DGREndorsement[]
     */
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \ABN\AbnServiceAPI\StructType\DgrFund[]
     */
     ...
     * @param \ABN\AbnServiceAPI\StructType\DGREndorsement[] $dgrEndorsement
     ...
     * @param \ABN\AbnServiceAPI\StructType\DgrFund[] $dgrFund
     */
    public function __construct(string $recordLastUpdatedDate, ?array $aBN = null, ?array $entityStatus = null, ?string $aSICNumber = null, ?array $legalName = null, ?array $mainName = null, ?\ABN\AbnServiceAPI\StructType\EntityType $entityType, ?array $goodsAndServicesTax = null, ?array $dgrEndorsement = null, ?array $mainTradingName = null, ?array $otherTradingName = null, ?array $mainBusinessPhysicalAddress = null, ?array $dgrFund = null)
    {
        $this
     ...
     * @param string $recordLastUpdatedDate
     * @return \ABN\AbnServiceAPI\StructType\ResponseBusinessEntity
     */
    ...
    public static function validateABNForArrayConstraintFromSetABN(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityABNItem) {
            ...
            if (!$responseBusinessEntityABNItem instanceof \ABN\AbnServiceAPI\StructType\Identifier) {
    ...
    public static function validateEntityStatusForArrayConstraintFromSetEntityStatus(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityEntityStatusItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityEntityStatusItem instanceof \ABN\AbnServiceAPI\StructType\EntityStatus) {
    ...
    public static function validateLegalNameForArrayConstraintFromSetLegalName(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityLegalNameItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityLegalNameItem instanceof \ABN\AbnServiceAPI\StructType\IndividualName) {
    ...
    public static function validateMainNameForArrayConstraintFromSetMainName(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityMainNameItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityMainNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationName) {
    ...
    public static function validateGoodsAndServicesTaxForArrayConstraintFromSetGoodsAndServicesTax(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityGoodsAndServicesTaxItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityGoodsAndServicesTaxItem instanceof \ABN\AbnServiceAPI\StructType\GoodsAndServicesTax) {
    ...
    public static function validateDgrEndorsementForArrayConstraintFromSetDgrEndorsement(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityDgrEndorsementItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityDgrEndorsementItem instanceof \ABN\AbnServiceAPI\StructType\DGREndorsement) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The dgrEndorsement property can only contain items of type \ABN\AbnServiceAPI\StructType\DGREndorsement, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ABN\AbnServiceAPI\StructType\DGREndorsement $item
     * @return \ABN\AbnServiceAPI\StructType\ResponseBusinessEntity
     */
    public function addToDgrEndorsement(\ABN\AbnServiceAPI\StructType\DGREndorsement $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\DGREndorsement) {
            throw new InvalidArgumentException(sprintf('The dgrEndorsement property can only contain items of type \ABN\AbnServiceAPI\StructType\DGREndorsement, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
    ...
    public static function validateMainTradingNameForArrayConstraintFromSetMainTradingName(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityMainTradingNameItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityMainTradingNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationName) {
    ...
    public static function validateOtherTradingNameForArrayConstraintFromSetOtherTradingName(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityOtherTradingNameItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityOtherTradingNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationName) {
    ...
    public static function validateMainBusinessPhysicalAddressForArrayConstraintFromSetMainBusinessPhysicalAddress(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityMainBusinessPhysicalAddressItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityMainBusinessPhysicalAddressItem instanceof \ABN\AbnServiceAPI\StructType\AddressDetails) {
    ...
    public static function validateDgrFundForArrayConstraintFromSetDgrFund(?array $values = []): string
    {
        ...
        foreach ($values as $responseBusinessEntityDgrFundItem) {
            // validation for constraint: itemType
            if (!$responseBusinessEntityDgrFundItem instanceof \ABN\AbnServiceAPI\StructType\DgrFund) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The dgrFund property can only contain items of type \ABN\AbnServiceAPI\StructType\DgrFund, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ABN\AbnServiceAPI\StructType\DgrFund $item
     * @return \ABN\AbnServiceAPI\StructType\ResponseBusinessEntity
     */
    public function addToDgrFund(\ABN\AbnServiceAPI\StructType\DgrFund $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\DgrFund) {
            throw new InvalidArgumentException(sprintf('The dgrFund property can only contain items of type \ABN\AbnServiceAPI\StructType\DgrFund, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->dgrFund[] = $item;
