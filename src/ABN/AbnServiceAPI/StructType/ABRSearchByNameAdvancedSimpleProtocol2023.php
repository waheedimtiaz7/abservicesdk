...
/**
 * This class stands for ABRSearchByNameAdvancedSimpleProtocol2023 StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ABRSearchByNameAdvancedSimpleProtocol2023 extends AbstractStructBase
{
    /**
     * The name
    ...
    /**
     * Constructor method for ABRSearchByNameAdvancedSimpleProtocol2023
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setName()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setPostcode()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setLegalName()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setBusinessName()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setActiveABNsOnly()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setNSW()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setSA()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setACT()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setVIC()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setWA()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setNT()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setQLD()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setTAS()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setAuthenticationGuid()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setSearchWidth()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setMinimumScore()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2023::setMaxSearchResults()
     * @param string $name
     ...
     */
    public function __construct(?string $name = null, ?string $postcode = null, ?string $legalName = null, ?string $businessName = null, ?string $activeABNsOnly = null, ?string $nSW = null, ?string $sA = null, ?string $aCT = null, ?string $vIC = null, ?string $wA = null, ?string $nT = null, ?string $qLD = null, ?string $tAS = null, ?string $authenticationGuid = null, ?string $searchWidth = null, ?string $minimumScore = null, ?string $maxSearchResults = null)
    {
        $this
            ->setName($name)
     ...
     * Set name value
     * @param string $name
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByNameAdvancedSimpleProtocol2023
     */
