...
/**
 * This class stands for ABRSearchByNameAdvancedSimpleProtocol2006 StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ABRSearchByNameAdvancedSimpleProtocol2006 extends AbstractStructBase
{
    /**
     * The name
    ...
    /**
     * Constructor method for ABRSearchByNameAdvancedSimpleProtocol2006
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setName()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setPostcode()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setLegalName()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setTradingName()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setNSW()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setSA()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setACT()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setVIC()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setWA()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setNT()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setQLD()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setTAS()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setAuthenticationGuid()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setSearchWidth()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setMinimumScore()
     * @uses ABRSearchByNameAdvancedSimpleProtocol2006::setMaxSearchResults()
     * @param string $name
     ...
     */
    public function __construct(?string $name = null, ?string $postcode = null, ?string $legalName = null, ?string $tradingName = null, ?string $nSW = null, ?string $sA = null, ?string $aCT = null, ?string $vIC = null, ?string $wA = null, ?string $nT = null, ?string $qLD = null, ?string $tAS = null, ?string $authenticationGuid = null, ?string $searchWidth = null, ?string $minimumScore = null, ?string $maxSearchResults = null)
    {
        $this
            ->setName($name)
     ...
     * Set name value
     * @param string $name
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByNameAdvancedSimpleProtocol2006
     */
