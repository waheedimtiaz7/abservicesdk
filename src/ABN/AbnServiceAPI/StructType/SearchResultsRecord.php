...
class SearchResultsRecord extends AbstractStructBase
{
     ...
     * - maxOccurs: unbounded
     * - minOccurs: 0
     * @var \ABN\AbnServiceAPI\StructType\IdentifierSummary[]
     */
     ...
     * - maxOccurs: 1
     * - minOccurs: 0
     * @var \ABN\AbnServiceAPI\StructType\IndividualSimpleName[]
     */
     ...
     * - minOccurs: 0
     * - nillable: true
     * @var \ABN\AbnServiceAPI\StructType\AddressSimple[]
     */
     ...
     * @param \ABN\AbnServiceAPI\StructType\IdentifierSummary[] $aBN
     * @param \ABN\AbnServiceAPI\StructType\IndividualSimpleName[] $legalName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $mainName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $mainTradingName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $otherTradingName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $pBIEName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $aWEFName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $businessName
     * @param \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[] $dgrFundName
     * @param \ABN\AbnServiceAPI\StructType\AddressSimple[] $mainBusinessPhysicalAddress
     */
    ...
    /**
     * Get ABN value
     * @return \ABN\AbnServiceAPI\StructType\IdentifierSummary[]
     */
    ...
    public static function validateABNForArrayConstraintFromSetABN(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordABNItem) {
            ...
            if (!$searchResultsRecordABNItem instanceof \ABN\AbnServiceAPI\StructType\IdentifierSummary) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The ABN property can only contain items of type \ABN\AbnServiceAPI\StructType\IdentifierSummary, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ABN\AbnServiceAPI\StructType\IdentifierSummary $item
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToABN(\ABN\AbnServiceAPI\StructType\IdentifierSummary $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\IdentifierSummary) {
            throw new InvalidArgumentException(sprintf('The ABN property can only contain items of type \ABN\AbnServiceAPI\StructType\IdentifierSummary, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        $this->ABN[] = $item;
    ...
    /**
     * Get legalName value
     * @return \ABN\AbnServiceAPI\StructType\IndividualSimpleName[]|null
     */
    ...
    public static function validateLegalNameForArrayConstraintFromSetLegalName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordLegalNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordLegalNameItem instanceof \ABN\AbnServiceAPI\StructType\IndividualSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The legalName property can only contain items of type \ABN\AbnServiceAPI\StructType\IndividualSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ABN\AbnServiceAPI\StructType\IndividualSimpleName $item
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToLegalName(\ABN\AbnServiceAPI\StructType\IndividualSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\IndividualSimpleName) {
            throw new InvalidArgumentException(sprintf('The legalName property can only contain items of type \ABN\AbnServiceAPI\StructType\IndividualSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    /**
     * Get mainName value
     * @return \ABN\AbnServiceAPI\StructType\OrganisationSimpleName[]|null
     */
    ...
    public static function validateMainNameForArrayConstraintFromSetMainName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordMainNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordMainNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The mainName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToMainName(\ABN\AbnServiceAPI\StructType\OrganisationSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
            throw new InvalidArgumentException(sprintf('The mainName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    public static function validateMainTradingNameForArrayConstraintFromSetMainTradingName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordMainTradingNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordMainTradingNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The mainTradingName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToMainTradingName(\ABN\AbnServiceAPI\StructType\OrganisationSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
            throw new InvalidArgumentException(sprintf('The mainTradingName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    public static function validateOtherTradingNameForArrayConstraintFromSetOtherTradingName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordOtherTradingNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordOtherTradingNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The otherTradingName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToOtherTradingName(\ABN\AbnServiceAPI\StructType\OrganisationSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
            throw new InvalidArgumentException(sprintf('The otherTradingName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    public static function validatePBIENameForArrayConstraintFromSetPBIEName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordPBIENameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordPBIENameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The PBIEName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToPBIEName(\ABN\AbnServiceAPI\StructType\OrganisationSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
            throw new InvalidArgumentException(sprintf('The PBIEName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    public static function validateAWEFNameForArrayConstraintFromSetAWEFName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordAWEFNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordAWEFNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The AWEFName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToAWEFName(\ABN\AbnServiceAPI\StructType\OrganisationSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
            throw new InvalidArgumentException(sprintf('The AWEFName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    public static function validateBusinessNameForArrayConstraintFromSetBusinessName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordBusinessNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordBusinessNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The businessName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToBusinessName(\ABN\AbnServiceAPI\StructType\OrganisationSimpleName $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
            throw new InvalidArgumentException(sprintf('The businessName property can only contain items of type \ABN\AbnServiceAPI\StructType\OrganisationSimpleName, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
        // validation for constraint: choice(legalName, mainName, mainTradingName, otherTradingName, PBIEName, AWEFName, businessName, dgrFundName)
    ...
    public static function validateDgrFundNameForArrayConstraintFromSetDgrFundName(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordDgrFundNameItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordDgrFundNameItem instanceof \ABN\AbnServiceAPI\StructType\OrganisationSimpleName) {
    ...
    public static function validateMainBusinessPhysicalAddressForArrayConstraintFromSetMainBusinessPhysicalAddress(?array $values = []): string
    {
        ...
        foreach ($values as $searchResultsRecordMainBusinessPhysicalAddressItem) {
            // validation for constraint: itemType
            if (!$searchResultsRecordMainBusinessPhysicalAddressItem instanceof \ABN\AbnServiceAPI\StructType\AddressSimple) {
        ...
        if (!empty($invalidValues)) {
            $message = sprintf('The mainBusinessPhysicalAddress property can only contain items of type \ABN\AbnServiceAPI\StructType\AddressSimple, %s given', is_object($invalidValues) ? get_class($invalidValues) : (is_array($invalidValues) ? implode(', ', $invalidValues) : gettype($invalidValues)));
        }
        unset($invalidValues);
     ...
     * @throws InvalidArgumentException
     * @param \ABN\AbnServiceAPI\StructType\AddressSimple $item
     * @return \ABN\AbnServiceAPI\StructType\SearchResultsRecord
     */
    public function addToMainBusinessPhysicalAddress(\ABN\AbnServiceAPI\StructType\AddressSimple $item): self
    {
        // validation for constraint: itemType
        if (!$item instanceof \ABN\AbnServiceAPI\StructType\AddressSimple) {
            throw new InvalidArgumentException(sprintf('The mainBusinessPhysicalAddress property can only contain items of type \ABN\AbnServiceAPI\StructType\AddressSimple, %s given', is_object($item) ? get_class($item) : (is_array($item) ? implode(', ', $item) : gettype($item))), __LINE__);
        }
