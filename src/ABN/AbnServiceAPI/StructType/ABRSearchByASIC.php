...
/**
 * This class stands for ABRSearchByASIC StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ABRSearchByASIC extends AbstractStructBase
{
    /**
     * The searchString
    ...
    /**
     * Constructor method for ABRSearchByASIC
     * @uses ABRSearchByASIC::setSearchString()
     * @uses ABRSearchByASIC::setIncludeHistoricalDetails()
     * @uses ABRSearchByASIC::setAuthenticationGuid()
     ...
     * @param string $searchString
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByASIC
     */
