...
class ABRSearchByNameAdvanced2017 extends AbstractStructBase
{
     ...
     */
    protected ?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2017 $externalNameSearch = null;
    /**
     ...
     * @param \ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2017 $externalNameSearch
     * @param string $authenticationGuid
     */
    public function __construct(?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2017 $externalNameSearch = null, ?string $authenticationGuid = null)
    {
        $this
     ...
     */
    public function getExternalNameSearch(): ?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2017
    {
     ...
     * @param \ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2017 $externalNameSearch
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByNameAdvanced2017
     */
    public function setExternalNameSearch(?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2017 $externalNameSearch = null): self
    {
