...
/**
 * This class stands for SearchByRegistrationEventResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class SearchByRegistrationEventResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for SearchByRegistrationEventResponse
     * @uses SearchByRegistrationEventResponse::setABRPayloadSearchResults()
     ...
     * @param \ABN\AbnServiceAPI\StructType\Payload $aBRPayloadSearchResults
     * @return \ABN\AbnServiceAPI\StructType\SearchByRegistrationEventResponse
     */
