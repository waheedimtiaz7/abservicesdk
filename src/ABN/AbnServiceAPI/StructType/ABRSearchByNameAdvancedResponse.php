...
/**
 * This class stands for ABRSearchByNameAdvancedResponse StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ABRSearchByNameAdvancedResponse extends AbstractStructBase
{
    /**
    ...
    /**
     * Constructor method for ABRSearchByNameAdvancedResponse
     * @uses ABRSearchByNameAdvancedResponse::setABRPayloadSearchResults()
     ...
     * @param \ABN\AbnServiceAPI\StructType\Payload $aBRPayloadSearchResults
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByNameAdvancedResponse
     */
