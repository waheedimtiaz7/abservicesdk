...
/**
 * This class stands for ABRSearchByABN StructType
 * @subpackage Structs
 */
#[\AllowDynamicProperties]
class ABRSearchByABN extends AbstractStructBase
{
    /**
     * The searchString
    ...
    /**
     * Constructor method for ABRSearchByABN
     * @uses ABRSearchByABN::setSearchString()
     * @uses ABRSearchByABN::setIncludeHistoricalDetails()
     * @uses ABRSearchByABN::setAuthenticationGuid()
     ...
     * @param string $searchString
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByABN
     */
