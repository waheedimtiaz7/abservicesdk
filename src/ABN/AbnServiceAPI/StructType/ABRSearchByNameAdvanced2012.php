...
class ABRSearchByNameAdvanced2012 extends AbstractStructBase
{
     ...
     */
    protected ?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2012 $externalNameSearch = null;
    /**
     ...
     * @param \ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2012 $externalNameSearch
     * @param string $authenticationGuid
     */
    public function __construct(?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2012 $externalNameSearch = null, ?string $authenticationGuid = null)
    {
        $this
     ...
     */
    public function getExternalNameSearch(): ?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2012
    {
     ...
     * @param \ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2012 $externalNameSearch
     * @return \ABN\AbnServiceAPI\StructType\ABRSearchByNameAdvanced2012
     */
    public function setExternalNameSearch(?\ABN\AbnServiceAPI\StructType\ExternalRequestNameSearchAdvanced2012 $externalNameSearch = null): self
    {
